...
// ── Server factory ──────────────────────────────────────────────────
//
// Builds a fully-configured MCP server. A fresh instance is created per
// stateless HTTP request (and once for the stdio entry point) so that
// concurrent requests never share a single transport.
